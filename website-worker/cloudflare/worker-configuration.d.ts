/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/tmp/rehoyo-worker-vars.AZ28El cloudflare/worker-configuration.d.ts` (hash: a2684224a46a7fae4cb80901829b78fd)
