/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare/worker-configuration.d.ts` (hash: bd668d1d02664940dbfc1340f81bae47)
// Runtime types generated with workerd@1.20260722.1 2026-07-25 nodejs_compat
interface __BaseEnv_Env {
	PET_POLICIES: KVNamespace;
	ASSETS: Fetcher;
	PET_STREAM: DurableObjectNamespace<import("./worker").PetBroadcastShard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "PetBroadcastShard";
	}
