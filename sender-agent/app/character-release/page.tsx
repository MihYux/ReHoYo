...
export default function CharacterReleasePage() {
  ...
  const publish = (exampleMode: boolean) => {
    ...
    }), exampleMode ? "示例方案已按 100% 上传到 Cloudflare，桌宠将在下次同步时接收。" : `方案已按 ${rollout}% 灰度上传到 Cloudflare，桌宠将在下次同步时接收。`);
  };
